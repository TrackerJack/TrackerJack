...
Auto Export
_________________
#. Save your AE project file to a folder. This is the default location where your JSON file will be saved. 
You can also save to a custom file location (See Settings > JSON Save Location) 
